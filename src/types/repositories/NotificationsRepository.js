...
let NotificationsRepository = class NotificationsRepository {
    ...
    deserialize(obj) {
        return (0, json_mapper_1.deserialize)(obj, { type: models_1.NotificationModel, collectionType: (0, core_1.isArray)(obj) ? Array : undefined });
    }
...
], NotificationsRepository.prototype, "prisma", void 0);
