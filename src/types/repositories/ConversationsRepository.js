...
let ConversationsRepository = class ConversationsRepository {
    ...
    deserialize(obj) {
        return (0, json_mapper_1.deserialize)(obj, { type: models_1.ConversationModel, collectionType: (0, core_1.isArray)(obj) ? Array : undefined });
    }
...
], ConversationsRepository.prototype, "prisma", void 0);
ConversationsRepository = __decorate([
    (0, di_1.Injectable)()
