...
let FriendshipsRepository = class FriendshipsRepository {
    get collection() {
    ...
    deserialize(obj) {
        return (0, json_mapper_1.deserialize)(obj, { type: models_1.FriendshipModel, collectionType: (0, core_1.isArray)(obj) ? Array : undefined });
    }
...
], FriendshipsRepository.prototype, "prisma", void 0);
FriendshipsRepository = __decorate([
    (0, di_1.Injectable)()
