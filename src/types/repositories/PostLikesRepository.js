...
let PostLikesRepository = class PostLikesRepository {
    ...
    deserialize(obj) {
        return (0, json_mapper_1.deserialize)(obj, { type: models_1.PostLikeModel, collectionType: (0, core_1.isArray)(obj) ? Array : undefined });
    }
...
], PostLikesRepository.prototype, "prisma", void 0);
PostLikesRepository = __decorate([
    (0, di_1.Injectable)()
], PostLikesRepository);
