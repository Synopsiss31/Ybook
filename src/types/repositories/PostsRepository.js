...
let PostsRepository = class PostsRepository {
    ...
    deserialize(obj) {
        return (0, json_mapper_1.deserialize)(obj, { type: models_1.PostModel, collectionType: (0, core_1.isArray)(obj) ? Array : undefined });
    }
...
], PostsRepository.prototype, "prisma", void 0);
