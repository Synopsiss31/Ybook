        ...
        <div className='colorContainer'>
          <div className='colorContainerInside'>
            <div className='topBar'>
              ...
              <Image src={require(`../assets/1.png`)} alt="profile" className={style.profilePhoto} />
              <div className='nameStatus'>
                <span className='name'>{this.state.name}</span>
                <span>{this.state.Status}</span>
              </div>
              <div>
                <Image src={require(`../assets/icons/video-call.png`)} alt="video call" className={style.callIcon} />
                <Image src={require(`../assets/icons/phone-call.png`)} alt="audio call" className={style.callIcon} />
              </div>
            </div>
