...
import style from './chatPageMessage.module.css';
class ChatPageMessage extends React.Component {
    ...
    render() {
        return (
            <div className={this.props.message.from === "Mohcine" ? 'message myMessage' : 'message otherMessage'}>
