...
> {
  constructor(props: MessageSelectionProps) {
    super(props);
    this.statusClicked = this.statusClicked.bind(this);
  }

  statusClicked(status: number) {
  ...
  render() {
    return (
      <div id="messageSelection">
        <button
          className="messageSelectionStatus"
          id={
            this.props.selected === 1
              ? 'messageSelectionStatusSelected'
              : undefined
          }
          onClick={() => this.statusClicked(1)}
        >
          Messages <span id="numberUnreadTop">15</span>
        </button>
        <button
          className="messageSelectionStatus"
          id={
          ...
          onClick={() => this.statusClicked(2)}
        >
          Calls <span id="numberUnreadTop">25</span>
        </button>
        <style jsx>{`
          #messageSelection {
